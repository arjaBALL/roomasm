		...
		<div class="nav-content">
			...
			<table class="users-table">
				...
				<div class="demo_jui">
                   ...
                   FROM subjects s 
                   INNER JOIN teachers t ON s.TeacherID = t.TeacherID") or die(mysqli_error());
							while ($row = mysqli_fetch_array($result)) {
								...
								<tr class="del<?php echo $id ?>">
									...
									<td align="center" width="200">
										<a class="btn btn-info" href="edit_subject.php<?php echo '?id=' . $id; ?>"><i
										...
										<div class="modal hide fade" id="<?php echo $id; ?>">
											<div class="modal-header">
												...
												<div class="alert alert-info">
													<p>
														<font color="gray">Are you Sure you Want to Delete this Subjects
															Entry?</font>
													</p>
												</div>
											</div>
											<div class="modal-body">
												<a class="btn btn-info"
													href="delete_subject.php<?php echo '?id=' . $id; ?>"><i
